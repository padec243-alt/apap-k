...
export default function Home() {
  ...
  const missionLyonImage = PlaceHolderImages.find((img) => img.id === 'mission-lyon');
  const missionKasaiImage = PlaceHolderImages.find((img) => img.id === 'mission-kasai');
  const festivalNgomaImage = PlaceHolderImages.find((img) => img.id === 'festival-ngoma');
            ...
            <Card className="flex flex-col md:flex-row overflow-hidden">
              {missionLyonImage && (
                 <div className="md:w-1/3 relative min-h-[200px] md:min-h-full">
                    <Image src={missionLyonImage.imageUrl} alt="Mission à Lyon" layout="fill" objectFit="cover" data-ai-hint={missionLyonImage.imageHint} />
                </div>
              )}
             ...
             <Card className="flex flex-col md:flex-row overflow-hidden">
              {missionKasaiImage && (
                <div className="md:w-1/3 relative min-h-[200px] md:min-h-full">
                    <Image src={missionKasaiImage.imageUrl} alt="Mission au Kasaï" layout="fill" objectFit="cover" data-ai-hint={missionKasaiImage.imageHint} />
                </div>
              )}
              <div className="md:w-2/3 p-6">
          ...
          <div className="mt-12 grid max-w-6xl mx-auto gap-8 md:grid-cols-2">
            <Card className="shadow-lg flex flex-col">
             ...
             <Card className="shadow-lg flex flex-col">
              {festivalNgomaImage && (
                <div className="aspect-video relative">
                  <Image src={festivalNgomaImage.imageUrl} alt="Festival Ngoma" layout="fill" objectFit="cover" data-ai-hint={festivalNgomaImage.imageHint} />
                </div>
              )}
              <CardHeader>
                <CardTitle className="flex items-center gap-3 font-headline text-xl">
